...
function MembersSection({
    ...
    return (
        <div className="text-white xl:col-span-4 space-y-6">
            ...
            <div
                className="glass-card bg-white/5 border border-white/8 rounded-2xl overflow-hidden divide-y divide-white/8">
                {isFetching ? (
                    <>
                    ...
                    members!.map((member) => (
                        <MemberItem
                            onClick={member.internal_id ? undefined : () => openEditGuestNamePopup(member.member_id, member.name)}
