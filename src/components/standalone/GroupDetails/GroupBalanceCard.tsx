...
function GroupBalanceCard({ group }: { group: Group }) {
	return (
		<div className="lg:col-span-2 glass-card border border-white/8 bg-white/5 rounded-2xl p-8 flex flex-col md:flex-row items-center gap-8 relative overflow-hidden">
			...
			<div className="shrink-0 flex flex-col items-center md:items-end">
				...
				<button className="mt-4 bg-primary hover:bg-blue-600 text-white px-6 py-2 rounded-full font-semibold text-sm transition-all shadow-lg shadow-primary/20">
					Add Expense
				</button>
			</div>
		</div>
