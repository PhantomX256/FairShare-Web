        ...
        <section className="space-y-6 text-white">
            ...
            <div className="glass-card rounded-2xl overflow-hidden divide-y divide-white/5">
                <div className="p-4 flex items-center justify-between hover:bg-white/5 transition-all">
                    <div className="flex items-center gap-3">
                        <div className="size-10 rounded-full relative">
                            <img className="w-full h-full rounded-full object-cover" data-alt="Sarah Jenkins profile"
                            ...
                            <span
                                className="absolute bottom-0 right-0 size-2.5 bg-emerald-500 rounded-full border-2 border-card-dark"></span>
                        </div>
                        <div>
                            <p className="text-sm font-bold">Sarah Jenkins</p>
                            <p className="text-xs text-emerald-500">Owes you $250.00</p>
                        </div>
                    </div>
                    <button
                ...
                <div className="p-4 flex items-center justify-between hover:bg-white/5 transition-all">
                    <div className="flex items-center gap-3">
                        <div className="size-10 rounded-full relative">
                            <img className="w-full h-full rounded-full object-cover" data-alt="Mike Chen profile"
                            ...
                            <span
                                className="absolute bottom-0 right-0 size-2.5 bg-slate-500 rounded-full border-2 border-card-dark"></span>
                        </div>
                        <div>
                            <p className="text-sm font-bold">Mike Chen</p>
                            <p className="text-xs text-red-400">You owe $12.50</p>
                        </div>
                    </div>
                    <button
                        className="size-8 rounded-lg bg-slate-800 text-slate-400 flex items-center justify-center hover:bg-white/10 transition-all">
                ...
                <div className="p-4 flex items-center justify-between hover:bg-white/5 transition-all">
                    <div className="flex items-center gap-3">
                        <div className="size-10 rounded-full relative">
                            <img className="w-full h-full rounded-full object-cover" data-alt="Jordan Smith profile"
                        ...
                        <div>
                            ...
                            <p className="text-xs text-emerald-500">Owes you $45.00</p>
                        </div>
                    </div>
                    <button
                        className="size-8 rounded-lg bg-primary/10 text-primary flex items-center justify-center hover:bg-primary hover:text-white transition-all">
                ...
                <div className="p-4 flex items-center justify-between hover:bg-white/5 transition-all">
                    <div className="flex items-center gap-3">
                        <div className="size-10 rounded-full">
                            <img className="w-full h-full rounded-full object-cover" data-alt="Emily Watson profile"
                    ...
                    <button
                        className="size-8 rounded-lg bg-slate-800 text-slate-400 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all">
